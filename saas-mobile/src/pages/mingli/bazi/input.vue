...
.calendar-toggle{display:flex;justify-content:space-between;align-items:center;padding:28rpx 4rpx 10rpx;margin-top:8rpx;border-top:1rpx solid rgba(139,106,48,.12)}.toggle-title{font:700 28rpx STKaiti,serif;color:#2a3a55}.toggle-note{max-width:470rpx;margin-top:5rpx;color:#887b65;font-size:19rpx;line-height:1.5}.submit-btn{position:relative;height:108rpx;margin:38rpx 4rpx 0;border:none;border-radius:54rpx;color:#f6e7bd;background:linear-gradient(90deg,#0f2240,#2b4163 50%,#0f2240);box-shadow:0 18rpx 34rpx rgba(18,41,73,.28),inset 0 0 0 2rpx rgba(224,188,99,.6),inset 0 2rpx 0 rgba(255,255,255,.08);font:700 32rpx STKaiti,serif;letter-spacing:5rpx;overflow:hidden;transition:.2s}.submit-btn:active:not([disabled]){transform:translateY(2rpx);box-shadow:0 8rpx 18rpx rgba(18,41,73,.22),inset 0 0 0 2rpx rgba(224,188,99,.55)}.submit-btn::after{border:none}.submit-btn[disabled]{opacity:.4;background:linear-gradient(90deg,#3a3a3a,#5a5a5a);box-shadow:none}.btn-star{margin-right:16rpx;color:#dfbd65}.btn-arrow{margin-left:16rpx}.btn-orbit{position:absolute;width:220rpx;height:220rpx;border:1rpx solid rgba(224,190,105,.18);border-radius:50%;left:50%;top:-58rpx;margin-left:-110rpx;animation:spin 12s linear infinite}.tips{margin:32rpx 14rpx 0;padding:24rpx 28rpx;border-left:4rpx solid #af8436;background:rgba(245,235,214,.5);border-radius:0 12rpx 12rpx 0;display:flex;flex-direction:column;gap:10rpx;color:#6e6353;font-size:22rpx;line-height:1.6}.tips-title{color:#273856;font:700 27rpx STKaiti,serif;letter-spacing:2rpx}
@keyframes pulse{50%{opacity:.55;transform:scale(1.07)}}@keyframes spin{to{transform:rotate(360deg)}}
</style>
