...
.page{min-height:100vh;background:var(--ming-paper);color:#172747}.hero{position:relative;min-height:680rpx;overflow:hidden;background:var(--ming-gradient-hero)}.hero-content{position:relative;z-index:3;display:flex;flex-direction:column;align-items:center;padding-top:12rpx}.eyebrow{color:var(--ming-text-purple-soft);font:18rpx Georgia,serif;letter-spacing:7rpx}.gua-name-wrap{position:relative;width:230rpx;height:230rpx;margin-top:22rpx;display:flex;align-items:center;justify-content:center;border:1rpx solid var(--ming-border-purple);border-radius:50%}.gua-name-wrap::before,.gua-name-wrap::after{content:'';position:absolute;border:1rpx dashed var(--ming-purple-faint);border-radius:50%;animation:spin 20s linear infinite}.gua-name-wrap::before{inset:-26rpx}.gua-name-wrap::after{inset:24rpx;animation-direction:reverse}.gua-name{position:relative;z-index:2;color:var(--ming-text-purple);font:700 106rpx STKaiti,serif;text-shadow:0 0 34rpx var(--ming-purple-soft);animation:guaGlow 3s ease-in-out infinite}.gua-halo{position:absolute;inset:68rpx;border-radius:50%;background:var(--ming-purple-soft);box-shadow:0 0 70rpx 35rpx var(--ming-shadow-purple);animation:haloPulse 4s ease-in-out infinite}.gua-full{margin-top:26rpx;color:var(--ming-text-purple);font:700 38rpx STKaiti,serif;letter-spacing:5rpx}.gua-ci{margin-top:8rpx;max-width:610rpx;color:var(--ming-text-purple-soft);font:22rpx STKaiti,serif;text-align:center}.change-pill{margin-top:18rpx;padding:10rpx 22rpx;display:flex;gap:16rpx;border:1rpx solid var(--ming-border-purple);border-radius:26rpx;color:var(--ming-purple-light);background:var(--ming-purple-faint);font-size:20rpx}.change-arrow{color:var(--ming-text-purple-soft)}
.paper-body{position:relative;margin-top:-18rpx;padding:38rpx 26rpx calc(48rpx + env(safe-area-inset-bottom));border-radius:34rpx 34rpx 0 0;background:linear-gradient(135deg,rgba(96,69,29,.035) 25%,transparent 25%) 0 0/18rpx 18rpx,var(--ming-paper)}.question-banner{padding:18rpx 24rpx;display:flex;align-items:center;gap:18rpx;border-left:4rpx solid #a97d2e;background:rgba(248,240,218,.72)}.question-label{padding:5rpx 12rpx;border:1rpx solid #9d742a;border-radius:16rpx;color:#936b27;font:20rpx STKaiti,serif}.question-text{flex:1;color:#263654;font-size:23rpx}.section-title{margin:30rpx 0 22rpx;display:flex;align-items:center;justify-content:center;gap:20rpx;color:#a07831;text-align:center}.section-title view,.card-heading view{display:flex;flex-direction:column}.title-main{color:#1b2e4e;font:700 38rpx STKaiti,serif;letter-spacing:5rpx}.title-sub,.card-subtitle{margin-top:3rpx;color:#8a7a60;font-size:18rpx;letter-spacing:3rpx}
.hexagram-card{padding:26rpx 16rpx;border:1rpx solid rgba(161,118,41,.48);border-radius:24rpx 8rpx;background:linear-gradient(180deg,rgba(251,245,228,.88),rgba(242,231,202,.78));box-shadow:0 14rpx 34rpx rgba(63,45,20,.1),inset 0 0 0 4rpx rgba(255,255,255,.2)}.hex-header,.hex-row{display:flex;align-items:center;text-align:center}.hex-header{height:54rpx;color:#7a6c52;font-size:20rpx;font-weight:600;border-bottom:1rpx solid rgba(148,108,40,.22)}.hex-header>text,.small-col,.change-col{width:16%}.hex-header .hex-main,.line-col{width:36%}.hex-row{position:relative;min-height:76rpx;border-bottom:1rpx solid rgba(141,103,40,.1)}.hex-row:last-of-type{border-bottom:0}.hex-row.shi{background:linear-gradient(90deg,transparent,rgba(205,168,81,.16),transparent)}.hex-row.ying{background:linear-gradient(90deg,transparent,rgba(71,118,157,.13),transparent)}.hex-row.dong::before{content:'';position:absolute;left:0;top:50%;width:6rpx;height:40rpx;margin-top:-20rpx;border-radius:3rpx;background:var(--ming-gradient-btn-soft);box-shadow:0 0 14rpx var(--ming-purple-soft);animation:dongBlink 1.6s ease-in-out infinite}.small-col{color:#5e5644;font-size:21rpx;font-weight:500}.branch{color:#956e2c;font:700 25rpx STKaiti,serif}.line-col{position:relative;display:flex;justify-content:center;align-items:center}.yao-line,.change-line{width:155rpx;height:14rpx;background:var(--ming-gradient-line);box-shadow:0 0 10rpx var(--ming-shadow-glow)}.yao-line.broken,.change-line.broken{background:linear-gradient(90deg,#a87c2e 0 42%,transparent 42% 58%,#a87c2e 58%)}.marker{position:absolute;right:2rpx;width:36rpx;height:36rpx;line-height:34rpx;border:1rpx solid #9a712d;border-radius:50%;color:#7a5c22;font:700 19rpx/34rpx STKaiti,serif;background:rgba(255,250,235,.7);box-shadow:0 2rpx 6rpx rgba(154,113,45,.18)}.change-col{display:flex;justify-content:center;color:#a19278}.change-line{width:64rpx;height:9rpx}.legend{padding-top:20rpx;display:flex;justify-content:center;gap:30rpx;color:#6e6353;font-size:19rpx;font-weight:500}.legend text{display:flex;align-items:center;gap:8rpx}.dot{width:14rpx;height:14rpx;border-radius:50%;box-shadow:0 0 8rpx currentColor}.dot-shi{background:#c29a45;color:#c29a45}.dot-ying{background:#6589a8;color:#6589a8}.dot-dong{background:#b55b42;color:#b55b42}
