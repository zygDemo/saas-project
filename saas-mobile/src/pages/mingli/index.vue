...
.hero { position: relative; height: 750rpx; overflow: hidden; background: radial-gradient(circle at 50% 52%, #253f68 0, #122544 42%, #07152d 78%); }
...
.history-btn { height: 58rpx; padding: 0 22rpx; display: flex; align-items: center; gap: 12rpx; border: 1rpx solid rgba(232, 197, 112, .35); border-radius: 32rpx; background: rgba(5, 18, 39, .5); font-size: 24rpx; }
...
.title { margin-top: 12rpx; color: #f6e4ac; font: 700 62rpx STKaiti, KaiTi, serif; letter-spacing: 14rpx; text-shadow: 0 0 30rpx rgba(230, 192, 100, .4); }
.subtitle { margin-top: 8rpx; color: rgba(241, 226, 184, .68); font-size: 24rpx; letter-spacing: 3rpx; }
...
.ring { position: absolute; border-radius: 50%; border: 1rpx solid rgba(229, 193, 104, .56); box-shadow: inset 0 0 22rpx rgba(224, 186, 94, .12), 0 0 20rpx rgba(224, 186, 94, .08); }
...
.branch { position: absolute; left: 50%; top: 50%; width: 36rpx; margin-left: -18rpx; margin-top: -18rpx; text-align: center; color: #e5c36f; font: 24rpx STKaiti, serif; transform: rotate(calc(var(--i) * 30deg)) translateY(-180rpx); }
...
.yin-yang { position: absolute; inset: 130rpx; display: flex; align-items: center; justify-content: center; border: 1rpx solid rgba(229, 193, 104, .55); border-radius: 50%; color: #f4da92; font-size: 82rpx; text-shadow: 0 0 30rpx #c39b44; }
.glow-core { position: absolute; inset: 160rpx; border-radius: 50%; background: rgba(244, 205, 111, .22); box-shadow: 0 0 80rpx 36rpx rgba(218, 170, 74, .22); }
.cloud { position: absolute; z-index: 5; bottom: -8rpx; color: #e9dfc9; opacity: .22; font-size: 220rpx; filter: blur(2rpx); }.cloud-left { left: -90rpx; }.cloud-right { right: -80rpx; transform: scaleX(-1); }
.paper-section { position: relative; z-index: 8; margin-top: -2rpx; padding: 54rpx 28rpx calc(50rpx + env(safe-area-inset-bottom)); background: linear-gradient(135deg, rgba(104, 76, 34, .035) 25%, transparent 25%) 0 0/18rpx 18rpx, #efe4cd; }
.paper-section::before { content: ''; position: absolute; left: 0; right: 0; top: -34rpx; height: 70rpx; background: radial-gradient(70rpx 36rpx at 12% 100%, #efe4cd 98%, transparent), radial-gradient(90rpx 46rpx at 42% 100%, #efe4cd 98%, transparent), radial-gradient(78rpx 40rpx at 76% 100%, #efe4cd 98%, transparent), radial-gradient(70rpx 38rpx at 100% 100%, #efe4cd 98%, transparent); }
.section-heading { position: relative; display: flex; flex-direction: column; align-items: center; margin-bottom: 34rpx; }.ornament { color: #b58a33; font-size: 34rpx; }.heading-title { font: 700 40rpx STKaiti, KaiTi, serif; letter-spacing: 3rpx; }.heading-subtitle { margin-top: 8rpx; font-size: 22rpx; color: #72664f; letter-spacing: 2rpx; }
.method-card { position: relative; min-height: 304rpx; margin-bottom: 24rpx; padding: 36rpx 30rpx; overflow: hidden; border: 1rpx solid rgba(197, 154, 63, .65); border-radius: 24rpx 8rpx 24rpx 8rpx; box-sizing: border-box; box-shadow: 0 14rpx 34rpx rgba(52, 39, 21, .12), inset 0 0 0 5rpx rgba(255,255,255,.18); transition: transform .2s; }.method-card:active { transform: scale(.985); }
.bazi-card { background: linear-gradient(135deg, #f8efd9 0%, #e8d5ad 100%); }.liuyao-card { background: linear-gradient(135deg, #172b50, #28365c); color: #f3e5bb; border-color: rgba(221, 184, 96, .48); }
.card-index { position: absolute; right: 20rpx; top: 4rpx; color: rgba(151, 109, 34, .12); font: 96rpx STKaiti, serif; }.liuyao-card .card-index { color: rgba(238, 204, 124, .09); }
.card-copy { position: relative; z-index: 4; width: 59%; display: flex; flex-direction: column; }.tag { width: fit-content; padding: 7rpx 14rpx; border: 1rpx solid rgba(158, 116, 37, .46); border-radius: 18rpx; color: #866528; font-size: 19rpx; letter-spacing: 2rpx; }.liuyao-card .tag { color: #d9b860; border-color: rgba(223, 189, 105, .4); }
.card-title { margin-top: 18rpx; font: 700 46rpx STKaiti, KaiTi, serif; letter-spacing: 4rpx; }.card-desc { margin-top: 10rpx; color: #675c48; font-size: 23rpx; line-height: 1.65; }.liuyao-card .card-desc { color: rgba(241, 229, 194, .66); }
.card-action { margin-top: 20rpx; display: flex; align-items: center; gap: 12rpx; color: #9a7026; font-size: 24rpx; font-weight: 600; }.liuyao-card .card-action { color: #e0bd64; }.arrow { font-size: 30rpx; }
...
.hexagram-art { position: absolute; right: 32rpx; top: 58rpx; width: 210rpx; display: flex; flex-direction: column-reverse; gap: 14rpx; align-items: center; }.mini-yao { width: 150rpx; height: 11rpx; background: #e4c36d; box-shadow: 0 0 12rpx rgba(224, 189, 95, .35); }.mini-yao.broken { background: linear-gradient(90deg,#e4c36d 0 42%,transparent 42% 58%,#e4c36d 58%); }.moon { position: absolute; right: -18rpx; top: -42rpx; color: rgba(237, 205, 128, .25); font-size: 154rpx; animation: breathe 4s infinite; }
.guide-card { margin-top: 32rpx; display: flex; align-items: center; gap: 22rpx; padding: 25rpx 28rpx; border-top: 1rpx solid rgba(158, 119, 48, .32); border-bottom: 1rpx solid rgba(158, 119, 48, .32); }.guide-star { color: #a6782b; font-size: 44rpx; }.guide-copy { display:flex; flex-direction:column; }.guide-title { font: 700 28rpx STKaiti,serif; }.guide-text { margin-top: 5rpx; color:#756952; font-size:22rpx; line-height:1.5; }.disclaimer { display:block; margin-top:28rpx; text-align:center; color:rgba(72,60,39,.52); font-size:19rpx; letter-spacing:1rpx; }
...
@keyframes enterUp { from { opacity:0; transform:translateY(28rpx); } to { opacity:1; transform:translateY(0); } } @keyframes spin { to { transform:rotate(360deg); } } @keyframes spinReverse { to { transform:rotate(-360deg); } } @keyframes breathe { 50% { filter:drop-shadow(0 0 22rpx rgba(231,194,105,.38)); transform:translateX(-50%) scale(1.025); } } @keyframes floatPlanet { 50% { transform:translateY(-9rpx); } }
@media (prefers-reduced-motion: reduce) { .enter,.astrolabe,.ring,.planet,.moon { animation:none; } }
</style>
