...
.bazi-card { background: linear-gradient(135deg, #fcf4e4 0%, #e7d3ac 100%); border-color: rgba(174, 128, 54, .30); box-shadow: 0 14rpx 32rpx rgba(111, 75, 31, .10); }.liuyao-card { background: linear-gradient(135deg, rgba(255,255,255,.05) 0%, rgba(255,255,255,.02) 100%), linear-gradient(135deg, var(--ming-bg-mid), var(--ming-bg-soft)); color: var(--ming-text-purple); border-color: rgba(227, 220, 255, .10); box-shadow: 0 16rpx 34rpx rgba(25, 19, 65, .20); }
...
.card-copy { position: relative; z-index: 4; width: 59%; display: flex; flex-direction: column; }.tag { width: fit-content; padding: 7rpx 14rpx; border: 1rpx solid rgba(176, 132, 60, .42); border-radius: 18rpx; color: #866528; font-size: 19rpx; letter-spacing: 2rpx; }.liuyao-card .tag { color: var(--ming-text-purple); border-color: rgba(227, 220, 255, .14); background: rgba(255,255,255,.04); }
.card-title { margin-top: 16rpx; font: 700 44rpx STKaiti, KaiTi, serif; letter-spacing: 4rpx; }.card-desc { margin-top: 10rpx; color: #5f5644; font-size: 23rpx; line-height: 1.6; }.liuyao-card .card-desc { color: rgba(247, 244, 255, .72); }
.card-action { margin-top: 18rpx; display: flex; align-items: center; color: #9a7026; font-size: 24rpx; font-weight: 600; }.liuyao-card .card-action { color: var(--ming-text-purple); }.arrow { font-size: 28rpx; margin-left: 10rpx; }
...
.theme-seg__item.active { color: #fff; background: linear-gradient(135deg, rgba(168,148,255,.18), rgba(111,83,247,.84)); border-color: rgba(178,159,255,.20); box-shadow: 0 10rpx 22rpx rgba(111, 83, 247, .16); }@media (prefers-reduced-motion: reduce){.hero-wave,.astrolabe,.ring-outer,.ring-mid,.glow-core,.element-orbit,.planet,.theme-seg__item.active{animation:none!important}}
</style>
