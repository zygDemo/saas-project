...
function handleDetail(item) {
  ...
  uni.navigateTo({
    url: buildRoute(APP_ROUTES.carloan.supplement.supplementDetail, buildSupplementRouteQuery({ uuid, creditOrderId, id: item.id, name, phone, remark, isSupplementCustomer: item.isSupplementCustomer || "", isSupplementVehicle: item.isSupplementVehicle || "", isSupplementOrder: item.isSupplementOrder || "", isSupplementFile: item.isSupplementFile || "" })),
  });
}
