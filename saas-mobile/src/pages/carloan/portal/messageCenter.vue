...
function handleMessageClick(msg) {
  ...
  if (msg.link) {
    ...
    uni.navigateTo({
      url: buildRoute(APP_ROUTES.carloan.precheck.applyProgress, buildDetailRouteQuery({ creditOrderId: msg.creditOrderId || msg.orderNo })),
    });
  }
}
  ...
  const demoMessages = [
    {
      ...
      read: false,
      link: buildRoute(APP_ROUTES.carloan.precheck.applyProgress, buildDetailRouteQuery({ creditOrderId: "SO20260613001" })),
    },
    {
      id: 2,
      type: "supplement",
      ...
      read: false,
      link: buildRoute(APP_ROUTES.carloan.supplement.supplementDetail, buildSupplementRouteQuery({ creditOrderId: "SO20260612003" })),
    },
    {
      id: 3,
      type: "signing",
      ...
      read: true,
      link: buildRoute(APP_ROUTES.carloan.signing.signCenter, buildSignRouteQuery({ creditOrderId: "SO20260611002" })),
    },
    {
      id: 4,
      type: "loan",
