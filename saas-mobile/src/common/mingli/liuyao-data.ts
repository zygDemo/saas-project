...
/** 八卦纳甲表 */
export const NAJIA_TABLE: Record<string, { gan: string; zhi: string[] }> = {
  乾: { gan: '甲', zhi: ['子', '寅', '辰'] },
  坤: { gan: '乙', zhi: ['未', '巳', '卯'] },
  震: { gan: '庚', zhi: ['子', '寅', '辰'] },
  巽: { gan: '辛', zhi: ['丑', '亥', '酉'] },
...
/** 六十四卦基础数据 */
export const GUA64_DATA: Record<string, { name: string; fullName: string; shiYao: number; yingYao: number; guaCi: string; palace: string }> = {
  // ========== 乾宫 ==========
...
/** 六十四卦爻辞（每卦6条，从初爻到上爻） */
export const YAO_CI_TABLE: Record<string, string[]> = {
  // ========== 乾宫 ==========
...
/** 六神起始映射 */
export const LIU_SHEN_START_MAP: Record<string, LiuShen> = {
  甲: '青龙', 乙: '青龙',
  丙: '朱雀', 丁: '朱雀',
  戊: '勾陈',
  己: '螣蛇',
...
/** 动爻含义文案 */
export const DONG_YAO_MEANINGS: Record<string, Record<string, string>> = {
  父母: {
    '阳变阴': '长辈关系有变，文书契约需谨慎',
    '阴变阳': '家庭事务好转，学业有成',
  },
...
/** 六亲五行生克规则 */
export const LIU_QIN_WUXING_RULES = {
  sheng: { 金: '水', 水: '木', 木: '火', 火: '土', 土: '金' } as Record<string, string>,
  ke: { 金: '木', 木: '土', 土: '水', 水: '火', 火: '金' } as Record<string, string>,
}
